...
```{r eyeball plots of data, eval=FALSE, include=FALSE}
...
freq_data %>% 
  ...
  geom_jitter(aes(y = lr_freq02, color = '02')) +
  geom_jitter(aes(y = lr_freq10, color = '10')) +
  geom_jitter(aes(y = lr_freq18, color = '18')) #+
  #geom_line(aes(y = lr_freq18))
